...
class __fitdph:
    ...
    def __init__(self,obs=None,initpi=None,initphgen=None,initexitrates=None,randominit=True,seed=None,tolerance=1e-9,itermax=1e6):
    ...
    def getaic(self):
        ...
        return 2*self.nparam-2*self.loglikelihood

    def getbic(self):
        #returns the Bayesian Information Criteria (BIC)
        return self.nparam*np.log(len(self.obs))-2*self.loglikelihood
